...
class AnimatedApplication(Adw.Application):
    ...
    def __init__(self):
        super().__init__(application_id='io.github.PinkAvocadoDev.Animated',
                         flags=Gio.ApplicationFlags.DEFAULT_FLAGS,
                         resource_base_path='/io/github/PinkAvocadoDev/Animated')
    ...
    def do_activate(self):
        ...
        if not win:
            win = AnimatedWindow(application=self)
        win.present()
